          ...
          <TopicContainer onClick={handleExpand1}>
            ...
            <TextContainer>
              ...
              <DescriptionContainer className="topic1" expand1={expand1}>
                ...
                <TopicContainer className="subTopic">
                  <Dot />
                  <span>Crítica ao modelo descritivo, que objetiva levantar uma série de informações so-bre determinados fenômenos e descrever suas características.</span>
                </TopicContainer>
                <TopicContainer className="subTopic">
                  <Dot />
                  <span>Interesse crescente no modelo explicativo longitudinal, que visam à identificação de fatores que contribuem para a ocorrên-cia de determinados fenômenos em um determinado período de tempo (em geral alguns anos) e analisam as mudanças ocorridas no fenômeno provocadas também pela passagem do tempo.</span>
                </TopicContainer>
              </DescriptionContainer>
            </TextContainer>
          </TopicContainer>
